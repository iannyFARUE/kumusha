...
/**
 * CORS (Cross-Origin Resource Sharing) configuration for the Kumusha API.
 *
 ...
 *
 * <p>The allowed origins are configured via the CORS_ORIGINS environment variable.
 */
@Configuration
public class CorsConfig {
    ...
    /**
     * Configures a CORS filter to allow cross-origin requests from the frontend.
     *
